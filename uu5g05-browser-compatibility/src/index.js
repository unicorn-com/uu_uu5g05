...
function doCheck() {
  let envConfig;
  if (window.uu5Environment) envConfig = window.uu5Environment.browserUpdate;
  else if (window.UU5 && window.UU5.Environment) envConfig = window.UU5.Environment.browserUpdate;
