import { TouchButton } from "uu5g05-elements";
...
async function setup(props = {}, opts) {
  return VisualComponent.setup(TouchButton, { ...getDefaultProps(), ...props }, opts);
}

describe("Uu5Elements.TouchButton", () => {
  ...
  it("checks default property values", async () => {
    ...
    expect(element).toHaveGdsSize(["spot", "basic", "xl"]);
