...
const QuarterRangeBoxInputs = createVisualComponent({
  //@@viewOn:statics
  uu5Tag: Config.TAG + "QuarterRangeBoxInputs",
  //@@viewOff:statics
...
//@@viewOn:exports
export { QuarterRangeBoxInputs };
export default QuarterRangeBoxInputs;
//@@viewOff:exports
