...
import NativeYearInput from "../../_native/year/input.js";
...
const Css = {
  ...
  input: ({ width = "4ch" } = {}) => Config.Css.css({ border: 0, outline: 0, width }),
};
//@@viewOff:css
...
const YearRangeBoxInputs = createVisualComponent({
  //@@viewOn:statics
  uu5Tag: Config.TAG + "YearRangeBoxInputs",
  //@@viewOff:statics
...
//@@viewOn:exports
export { YearRangeBoxInputs };
export default YearRangeBoxInputs;
//@@viewOff:exports
